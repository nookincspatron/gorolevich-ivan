...
public class CustomUserDetails implements UserDetails {
    ...
    public static CustomUserDetails toCustomUserDetails(User user) {
        ...
        customUserDetails.grantedAuthorities = Collections.singleton(new SimpleGrantedAuthority(user.getUserRole().getTitle()));

        return customUserDetails;
    }

    public static String toLogin(CustomUserDetails customUserDetails) {
